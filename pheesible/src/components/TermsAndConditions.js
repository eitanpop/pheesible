...
export default () => {
  return (
    <div>
      ...
      <h2>1. Terms</h2>
      <p>
        By accessing this Website, accessible from https://www.pheesible.com,
      ...
      <p>
        ...
        on Pheesible's Website for personal, non-commercial transitory viewing
      ...
      <ul>
        ...
        <li>
          attempt to reverse engineer any software contained on Pheesible's
          Website;
        </li>
        <li>
      ...
      <p>
        This will let Pheesible to terminate upon violations of any of these
      ...
      <h2>3. Disclaimer</h2>
      <p>
        All the materials on Pheesible’s Website are provided "as is". Pheesible
        makes no warranties, may it be expressed or implied, therefore negates
        all other warranties. Furthermore, Pheesible does not make any
      ...
      <h2>4. Limitations</h2>
      <p>
        Pheesible or its suppliers will not be hold accountable for any damages
        that will arise with the use or inability to use the materials on
        Pheesible’s Website, even if Pheesible or an authorize representative of
      ...
      <p>
        The materials appearing on Pheesible’s Website may include technical,
        typographical, or photographic errors. Pheesible will not promise that
        any of the materials in this Website are accurate, complete, or current.
        Pheesible may change the materials contained on its Website at any time
        without notice. Pheesible does not make any commitment to update the
        materials.
      </p>
      <h2>6. Links</h2>
      <p>
        Pheesible has not reviewed all of the sites linked to its Website and is
        not responsible for the contents of any such linked site. The presence
        of any link does not imply endorsement by Pheesible of the site. The use
        of any linked website is at the user’s own risk.
      </p>
      <h2>7. Site Terms of Use Modifications</h2>
      <p>
        Pheesible may revise these Terms of Use for its Website at any time
      ...
      <p>
        Any claim related to Pheesible's Website shall be governed by the laws
